...
# }
net <- function(income,fTax,sTax,lTax,loc,tsp_trad,trad,hsa){
    return(as.numeric(income-tsp_trad) - 
               fed_tax(as.numeric(income-tsp_trad-trad-hsa),fTax) - 
               state_tax(as.numeric(income-tsp_trad-trad-hsa),sTax,lTax,loc) - 
